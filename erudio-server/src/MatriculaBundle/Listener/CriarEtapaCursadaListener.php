...
/**
 * Cria um registro de etapa cursada em resposta à conclusão de uma enturmação, caso
 * o aluno tenha cursado todas as disciplinas obrigatórias que constituem a etapa.
 */
class CriarEtapaCursadaListener implements EventSubscriberInterface {
    ...
    function criarEtapaCursada($enturmacao, $status) {
        ...
        try {
            ...
            $this->etapaCursadaFacade->create($etapaCursada, false);
