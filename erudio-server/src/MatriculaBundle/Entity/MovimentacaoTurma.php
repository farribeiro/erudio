...
/**
* @ORM\Entity
* @ORM\Table(name = "edu_movimentacao_turma")
 */
class MovimentacaoTurma extends Movimentacao {
    
    /** 
    * @JMS\Groups({"LIST"})   
    * @ORM\ManyToOne(targetEntity = "Enturmacao") 
    * @ORM\JoinColumn(name = "enturmacao_origem_id", nullable = false)
    */
    ...
    * @JMS\Groups({"LIST"})   
    * @ORM\ManyToOne(targetEntity = "Enturmacao") 
    * @ORM\JoinColumn(name = "enturmacao_destino_id", nullable = false) 
    */
