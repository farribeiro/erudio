...
class Media extends AbstractEditableEntity {
    ...
    *  @ORM\ManyToOne(targetEntity = "DisciplinaCursada", inversedBy="medias") 
    *  @ORM\JoinColumn(name = "matricula_disciplina_id", nullable = false)
    */
    ...
    */
    ...
    function isExame() {
        return $this->nome === self::NOME_EXAME;
    }
