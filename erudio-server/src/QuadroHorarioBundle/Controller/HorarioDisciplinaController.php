...
use QuadroHorarioBundle\Entity\HorarioDisciplina;
use QuadroHorarioBundle\Service\HorarioDisciplinaFacade;
...
class HorarioCollection {
    ...
    /** @JMS\Type("ArrayCollection<QuadroHorarioBundle\Entity\HorarioDisciplina>") */
    public $horarios;
