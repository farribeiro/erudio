...
class DiaEventoController extends AbstractEntityController {
    ...
    *   @ParamConverter("diaEvento", converter="fos_rest.request_body")
    */
    function postAction(Request $request, DiaEvento $diaEvento, ConstraintViolationListInterface $errors) {
        return $this->post($request, $diaEvento, $errors);
    }
    ...
    *   @ParamConverter("diaEvento", converter="fos_rest.request_body")
    */
    function putAction(Request $request, $id, DiaEvento $diaEvento, ConstraintViolationListInterface $errors) {
        return $this->put($request, $id, $diaEvento, $errors);
    }
