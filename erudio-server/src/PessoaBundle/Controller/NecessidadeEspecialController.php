...
use PessoaBundle\Entity\NecessidaEspecial;

/**
 * @RouteResource("necessidades-especiais")
 */
class NecessidadeEspecialController extends AbstractEntityResource {
    
    function getEntityClass() {
        return 'PessoaBundle:NecessidadeEspecial';
    }
