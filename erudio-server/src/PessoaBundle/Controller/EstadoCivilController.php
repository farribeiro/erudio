...
/**
 * @RouteResource("estados-civis")
 */
class EstadoCivilController extends AbstractEntityResource {
    
    function getEntityClass() {
        return 'PessoaBundle:EstadoCivil';
    }
    
    /**
        * @ApiDoc(
        *   section = "Módulo Pessoa",
        *   description = "Busca um estado civil por seu id",
        * parameters={
    ...
    /**
        ...
        *   resource = true,
        *   section = "Módulo Pessoa",
        *   description = "Busca de estados civis",
        *   statusCodes = {
