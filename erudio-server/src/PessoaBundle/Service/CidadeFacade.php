    ...
    function parameterMap() {
        return [
            'estado' => function(QueryBuilder $qb, $value) {
                $qb->andWhere('c.estado = :estado')->setParameter('estado', $value);
            },
            'estado_sigla' => function(QueryBuilder $qb, $value) {
                $qb->join('c.estado', 'e')->andWhere('e.sigla = :sigla')->setParameter('sigla', $value);
            },
