...
abstract class AbstractFacade {
    ...
    */
     ...
     * @throws \Exception
     */
    function create($entidade, $isTransaction = true, $strictFlush = false) {
        try {
            ...
            $this->orm->getManager()->flush($strictFlush ? $entidade : null);
    ...
    */
     ...
     * @param type $restrict
     */
    function update($entidade, $strictFlush = true) {
