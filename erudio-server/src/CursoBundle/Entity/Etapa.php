...
class Etapa extends AbstractEditableEntity {
    ...
    * @ORM\JoinColumn(name = "quadro_horario_modelo_id", nullable = false) 
    */
    ...
    * @ORM\JoinColumn(name = "sistema_avaliacao_id", nullable = false)
    */
    private $sistemaAvaliacao;
    
    /** 
    * @JMS\Groups({"LIST"}) 
    * @ORM\Column(name = "idade_recomendada", type = "integer", nullable = true) 
    */
    ...
    */
    ...
    /** 
    * @JMS\Groups({"LIST"}) 
    * @ORM\Column(type = "boolean", name = "frequencia_unificada") 
    */
    ...
    */
    ...
    function getCargaHoraria() {
        return array_reduce($this->getDisciplinas()->toArray(), function($acc, $d) {
            return $acc + $d->getCargaHoraria();
        }, 0);
    }
    ...
    function getDisciplinas() {
        return $this->disciplinas->matching(
            Criteria::create()->where(Criteria::expr()->andX(              
                ...
                Criteria::expr()->eq('ofertado', true)
            ))
        ); 
    }
