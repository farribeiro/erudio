...
class ModeloQuadroHorario extends AbstractEditableEntity {
    ...
    * @JMS\Groups({"DETAILS"})
    * @JMS\Type("integer") 
    * @ORM\Column(name = "quantidade_aulas", type = "integer") 
    */
    ...
    * @JMS\Groups({"DETAILS"})
    * @JMS\Type("integer")
    * @ORM\Column(name = "duracao_aula", type = "integer") 
    */
    private $duracaoAula;
    ...
    * @JMS\Groups({"DETAILS"})
    * @JMS\Type("integer")
    * @ORM\Column(name = "duracao_intervalo", type = "integer") 
    */
    ...
    * @JMS\Groups({"DETAILS"})
    * @JMS\Type("integer") 
    * @ORM\Column(name = "posicao_intervalo", type = "integer") 
    */
