...
$catalogue = new MessageCatalogue('pt_BR', array (
  ...
  'messages' => 
  array (
    'Bad credentials' => 'Usuário ou senha incorreta. Verifique e tente novamente',
    'The presented password cannot be empty.' => 'Sua senha não pode ser vazia',
    'The presented password is invalid.' => 'Senha incorreta',
    'Access Denied' => 'Você não possui permissão para acessar este recurso',
    'Unauthorized' => 'Você não possui a permissão de acesso necessária',
    'Internal Server Error' => 'Erro interno do sistema (Contatar a DiTec para resolver)',
