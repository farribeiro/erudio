 ...
 */
class Endereco extends \SME\CommonsBundle\Entity\Endereco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'logradouro', 'numero', 'complemento', 'cep', 'bairro', 'cidade', 'latitude', 'longitude');
        }
     ...
     * {@inheritDoc}
     */
    public function setCidade(\SME\CommonsBundle\Entity\Cidade $cidade)
    {
