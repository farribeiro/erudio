 ...
 */
class TipoInscricao extends \SME\FilaUnicaBundle\Entity\TipoInscricao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'prioridade');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoInscricao $proxy) {
