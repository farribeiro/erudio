 ...
 */
class Situacao extends \SME\ProtocoloBundle\Entity\Situacao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'descricao', 'terminal', 'categoriaAplicavel');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Situacao $proxy) {
