 ...
 */
class ClasseEntidade extends \SME\CommonsBundle\Entity\ClasseEntidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'sigla', 'classePai');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClasseEntidade $proxy) {
    ...
    public function getClassePai()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getClassePai', array());

        return parent::getClassePai();
    }
    ...
    public function setClassePai($classePai)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClassePai', array($classePai));

        return parent::setClassePai($classePai);
    }
