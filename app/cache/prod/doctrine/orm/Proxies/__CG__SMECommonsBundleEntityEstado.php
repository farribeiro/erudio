 ...
 */
class Estado extends \SME\CommonsBundle\Entity\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'sigla', 'pais', 'ativo');
        }
     ...
     * {@inheritDoc}
     */
    public function setPais(\SME\CommonsBundle\Entity\Pais $pais)
    {
