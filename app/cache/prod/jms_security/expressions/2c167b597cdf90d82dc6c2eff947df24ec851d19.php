<?php
// Expression: #protocolo.getResponsavelAtual().getId() == user.getPessoa().getId()
return function(array $context) {
    ...
    return ($context['object']->arguments[$a['protocolo']]->getResponsavelAtual()->getId()) === ($context['user']->getPessoa()->getId());
};
