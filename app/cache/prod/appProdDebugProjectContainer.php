...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/www2/sistemas/intranet.educacao/app/cache/prod/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/www2/sistemas/intranet.educacao/app/cache/prod/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/www2/sistemas/intranet.educacao/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/www2/sistemas/intranet.educacao/app/Resources');
    ...
    protected function getDoctrine_Dbal_ErudioConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.erudio_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'erudio', 'host' => '10.10.1.191', 'port' => 3306, 'user' => 'gestao', 'password' => 'teste', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Dbal_MoodleConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.moodle_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'educacao_moodle', 'host' => 'pmi-db-mysql02', 'port' => 3306, 'user' => 'educacao_moodle', 'password' => 'eF5TyqlwjyqzDE9KswyPzHIzijQMCo9SAgBTOQbw', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Dbal_SmeConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.sme_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'educacao_portal', 'host' => 'pmi-db-mysql02', 'port' => 3306, 'user' => 'educacao', 'password' => 'eF5TsrUIj8xyM4o0DAqPUgIAHFAD2Q==', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager58daae04b1528_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager58daae04b1528_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_ErudioEntityManagerService()
    {
        require_once '/www2/sistemas/intranet.educacao/app/cache/prod/jms_diextra/doctrine/EntityManager_58daae04b1528.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_erudio_31ca42d214f5ee2baef324b7e4a95e7b');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_erudio_31ca42d214f5ee2baef324b7e4a95e7b');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_erudio_31ca42d214f5ee2baef324b7e4a95e7b');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/www2/sistemas/intranet.educacao/src/SME/ErudioBundle/Entity')), 'SME\\ErudioBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('ErudioBundle' => 'SME\\ErudioBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/www2/sistemas/intranet.educacao/app/cache/prod/doctrine/orm/Proxies');
        ...
        $f = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.erudio_connection'), $e);
        $this->get('doctrine.orm.erudio_manager_configurator')->configure($f);

        return $this->services['doctrine.orm.erudio_entity_manager'] = new \EntityManager58daae04b1528_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getDoctrine_Orm_MoodleEntityManagerService()
    {
        ...
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_moodle_31ca42d214f5ee2baef324b7e4a95e7b');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_moodle_31ca42d214f5ee2baef324b7e4a95e7b');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_moodle_31ca42d214f5ee2baef324b7e4a95e7b');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/www2/sistemas/intranet.educacao/src/SME/MoodleBundle/Entity')), 'SME\\MoodleBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('MoodleBundle' => 'SME\\MoodleBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        ...
        $f = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.moodle_connection'), $e);
        $this->get('doctrine.orm.moodle_manager_configurator')->configure($f);

        return $this->services['doctrine.orm.moodle_entity_manager'] = new \EntityManager58daae04b1528_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getDoctrine_Orm_SmeEntityManagerService()
    {
        ...
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_sme_31ca42d214f5ee2baef324b7e4a95e7b');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_sme_31ca42d214f5ee2baef324b7e4a95e7b');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_sme_31ca42d214f5ee2baef324b7e4a95e7b');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/www2/sistemas/intranet.educacao/src/SME/CommonsBundle/Entity', 1 => '/www2/sistemas/intranet.educacao/src/SME/DGPBundle/Entity', 2 => '/www2/sistemas/intranet.educacao/src/SME/DGPContratacaoBundle/Entity', 3 => '/www2/sistemas/intranet.educacao/src/SME/DGPFormacaoBundle/Entity', 4 => '/www2/sistemas/intranet.educacao/src/SME/DGPPromocaoBundle/Entity', 5 => '/www2/sistemas/intranet.educacao/src/SME/DGPPermutaBundle/Entity', 6 => '/www2/sistemas/intranet.educacao/src/SME/DGPProcessoAnualBundle/Entity', 7 => '/www2/sistemas/intranet.educacao/src/SME/FilaUnicaBundle/Entity', 8 => '/www2/sistemas/intranet.educacao/src/SME/IntranetBundle/Entity', 9 => '/www2/sistemas/intranet.educacao/src/SME/PresencaBundle/Entity', 10 => '/www2/sistemas/intranet.educacao/src/SME/ProtocoloBundle/Entity', 11 => '/www2/sistemas/intranet.educacao/src/SME/SuporteTecnicoBundle/Entity', 12 => '/www2/sistemas/intranet.educacao/src/SME/QuestionarioBundle/Entity', 13 => '/www2/sistemas/intranet.educacao/src/SME/EstagioBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'SME\\CommonsBundle\\Entity');
        $f->addDriver($e, 'SME\\DGPBundle\\Entity');
        $f->addDriver($e, 'SME\\DGPContratacaoBundle\\Entity');
        $f->addDriver($e, 'SME\\DGPFormacaoBundle\\Entity');
        $f->addDriver($e, 'SME\\DGPPromocaoBundle\\Entity');
        $f->addDriver($e, 'SME\\DGPPermutaBundle\\Entity');
        $f->addDriver($e, 'SME\\DGPProcessoAnualBundle\\Entity');
        $f->addDriver($e, 'SME\\FilaUnicaBundle\\Entity');
        $f->addDriver($e, 'SME\\IntranetBundle\\Entity');
        $f->addDriver($e, 'SME\\PresencaBundle\\Entity');
        $f->addDriver($e, 'SME\\ProtocoloBundle\\Entity');
        $f->addDriver($e, 'SME\\SuporteTecnicoBundle\\Entity');
        $f->addDriver($e, 'SME\\QuestionarioBundle\\Entity');
        $f->addDriver($e, 'SME\\EstagioBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('CommonsBundle' => 'SME\\CommonsBundle\\Entity', 'DGPBundle' => 'SME\\DGPBundle\\Entity', 'DGPContratacaoBundle' => 'SME\\DGPContratacaoBundle\\Entity', 'DGPFormacaoBundle' => 'SME\\DGPFormacaoBundle\\Entity', 'DGPPromocaoBundle' => 'SME\\DGPPromocaoBundle\\Entity', 'DGPPermutaBundle' => 'SME\\DGPPermutaBundle\\Entity', 'DGPProcessoAnualBundle' => 'SME\\DGPProcessoAnualBundle\\Entity', 'FilaUnicaBundle' => 'SME\\FilaUnicaBundle\\Entity', 'IntranetBundle' => 'SME\\IntranetBundle\\Entity', 'PresencaBundle' => 'SME\\PresencaBundle\\Entity', 'ProtocoloBundle' => 'SME\\ProtocoloBundle\\Entity', 'SuporteTecnicoBundle' => 'SME\\SuporteTecnicoBundle\\Entity', 'QuestionarioBundle' => 'SME\\QuestionarioBundle\\Entity', 'EstagioBundle' => 'SME\\EstagioBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/www2/sistemas/intranet.educacao/app/cache/prod/doctrine/orm/Proxies');
        ...
        $g->setNamingStrategy($this->get('doctrine.orm.naming_strategy.default'));

        $h = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.sme_connection'), $g);
        $this->get('doctrine.orm.sme_manager_configurator')->configure($h);

        return $this->services['doctrine.orm.sme_entity_manager'] = new \EntityManager58daae04b1528_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($h, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/www2/sistemas/intranet.educacao/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'W!a@r#n$i%n&g');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/www2/sistemas/intranet.educacao/app/cache/prod/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/www2/sistemas/intranet.educacao/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/www2/sistemas/intranet.educacao/app/config/routing.yml', array('cache_dir' => '/www2/sistemas/intranet.educacao/app/cache/prod', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appProdUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appProdUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginService()
    {
        ...
        return $this->services['security.firewall.map.context.login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.main')), 'login', $b, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '58daae04156c4', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login', NULL, NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, $this->get('security.logout.success_handler'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $f->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $this->get('security.authentication.success_handler'), new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/www2/sistemas/intranet.educacao/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/www2/sistemas/intranet.educacao/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/www2/sistemas/intranet.educacao/app/cache/prod/sessions');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $instance->setUsername('educacaoitajai');
        $instance->setPassword('warningeducacao');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/www2/sistemas/intranet.educacao/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/www2/sistemas/intranet.educacao/app/cache/prod/translations', 'debug' => true));

        $instance->setFallbackLocales(array(0 => 'pt_BR'));
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf', 'cy', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf', 'sq', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf', 'af', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf', 'tr', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf', 'no', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf', 'el', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf', 'uk', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ua.xlf', 'ua', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf', 'lv', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf', 'el', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.tr.xlf', 'tr', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.da.xlf', 'da', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.fr.xlf', 'fr', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.sr_Cyrl.xlf', 'sr_Cyrl', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.sr_Latn.xlf', 'sr_Latn', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.it.xlf', 'it', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.fa.xlf', 'fa', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.hu.xlf', 'hu', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.en.xlf', 'en', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.ja.xlf', 'ja', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.ua.xlf', 'ua', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.nl.xlf', 'nl', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.ar.xlf', 'ar', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.ru.xlf', 'ru', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.ca.xlf', 'ca', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.no.xlf', 'no', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.sk.xlf', 'sk', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.sl.xlf', 'sl', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.ro.xlf', 'ro', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.el.xlf', 'el', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.de.xlf', 'de', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.pl.xlf', 'pl', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.cs.xlf', 'cs', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.es.xlf', 'es', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.pt_BR.xlf', 'pt_BR', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.sv.xlf', 'sv', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.gl.xlf', 'gl', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.lb.xlf', 'lb', 'security');
        $instance->addResource('xlf', '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../../Resources/translations/security.pt_PT.xlf', 'pt_PT', 'security');
        $instance->addResource('yml', '/www2/sistemas/intranet.educacao/app/Resources/translations/messages.pt_BR.yml', 'pt_BR', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/www2/sistemas/intranet.educacao/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/www2/sistemas/intranet.educacao/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/www2/sistemas/intranet.educacao/app/Resources/TwigBundle/views', 'Twig');
        $instance->addPath('/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/www2/sistemas/intranet.educacao/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/www2/sistemas/intranet.educacao/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/IntranetBundle/Resources/views', 'Intranet');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/DGPBundle/Resources/views', 'DGP');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/DGPContratacaoBundle/Resources/views', 'DGPContratacao');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/DGPFormacaoBundle/Resources/views', 'DGPFormacao');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/DGPProcessoAnualBundle/Resources/views', 'DGPProcessoAnual');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/DGPPromocaoBundle/Resources/views', 'DGPPromocao');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/DGPPermutaBundle/Resources/views', 'DGPPermuta');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/ProtocoloBundle/Resources/views', 'Protocolo');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/FilaUnicaBundle/Resources/views', 'FilaUnica');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/SuporteTecnicoBundle/Resources/views', 'SuporteTecnico');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/PublicBundle/Resources/views', 'Public');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/PresencaBundle/Resources/views', 'Presenca');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/QuestionarioBundle/Resources/views', 'Questionario');
        $instance->addPath('/www2/sistemas/intranet.educacao/src/SME/EstagioBundle/Resources/views', 'Estagio');
        $instance->addPath('/www2/sistemas/intranet.educacao/app/Resources/views');
        $instance->addPath('/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/www2/sistemas/intranet.educacao/app/../web', true);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58daae04156c4'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.main'), new \Symfony\Component\Security\Core\User\UserChecker(), 'secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/www2/sistemas/intranet.educacao/app/cache/prod/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/www2/sistemas/intranet.educacao/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => '/www2/sistemas/intranet.educacao/src/SME/CommonsBundle/Resources/config/validation.yml', 1 => '/www2/sistemas/intranet.educacao/src/SME/DGPBundle/Resources/config/validation.yml', 2 => '/www2/sistemas/intranet.educacao/src/SME/DGPFormacaoBundle/Resources/config/validation.yml', 3 => '/www2/sistemas/intranet.educacao/src/SME/DGPPromocaoBundle/Resources/config/validation.yml', 4 => '/www2/sistemas/intranet.educacao/src/SME/SuporteTecnicoBundle/Resources/config/validation.yml', 5 => '/www2/sistemas/intranet.educacao/src/SME/PresencaBundle/Resources/config/validation.yml', 6 => '/www2/sistemas/intranet.educacao/src/SME/EstagioBundle/Resources/config/validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/www2/sistemas/intranet.educacao/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/www2/sistemas/intranet.educacao/app/cache/prod',
            'kernel.logs_dir' => '/www2/sistemas/intranet.educacao/app/logs',
            ...
            'debug.container.dump' => '/www2/sistemas/intranet.educacao/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => '/www2/sistemas/intranet.educacao/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/www2/sistemas/intranet.educacao/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/www2/sistemas/intranet.educacao/src/SME/CommonsBundle/Resources/config/validation.yml',
                1 => '/www2/sistemas/intranet.educacao/src/SME/DGPBundle/Resources/config/validation.yml',
                2 => '/www2/sistemas/intranet.educacao/src/SME/DGPFormacaoBundle/Resources/config/validation.yml',
                3 => '/www2/sistemas/intranet.educacao/src/SME/DGPPromocaoBundle/Resources/config/validation.yml',
                4 => '/www2/sistemas/intranet.educacao/src/SME/SuporteTecnicoBundle/Resources/config/validation.yml',
                5 => '/www2/sistemas/intranet.educacao/src/SME/PresencaBundle/Resources/config/validation.yml',
                6 => '/www2/sistemas/intranet.educacao/src/SME/EstagioBundle/Resources/config/validation.yml',
            ),
            ...
            'router.resource' => '/www2/sistemas/intranet.educacao/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/www2/sistemas/intranet.educacao/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'assetic.cache_dir' => '/www2/sistemas/intranet.educacao/app/cache/prod/assetic',
            ...
            'assetic.read_from' => '/www2/sistemas/intranet.educacao/app/../web',
            'assetic.write_to' => '/www2/sistemas/intranet.educacao/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/www2/sistemas/intranet.educacao/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/www2/sistemas/intranet.educacao/app/cache/prod/jms_aop',
            ...
            'security.extra.cache_dir' => '/www2/sistemas/intranet.educacao/app/cache/prod/jms_security',
            ...
            'jms_di_extra.cache_dir' => '/www2/sistemas/intranet.educacao/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/www2/sistemas/intranet.educacao/app/cache/prod/jms_diextra/doctrine/EntityManager_58daae04b1528.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager58daae04b1528_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
        );
    }
}
