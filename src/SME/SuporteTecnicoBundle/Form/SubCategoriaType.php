...
class SubCategoriaType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
            ...
            ->add('categoriaPai', 'entity', array('required' => false, 'label' => 'Categoria Pai: ', 'attr' => array('class' => 'form-control hidden'), 'class' => 'SuporteTecnicoBundle:Categoria', 'query_builder' => function($repository) { return $repository->createQueryBuilder('p'); }, 'property' => 'nome'))
            ->add('equipe', 'entity', array('label' => 'Equipe:', 'attr' => array('class' => 'form-control hidden'), 'class' => 'SuporteTecnicoBundle:Equipe', 'query_builder' => function($repository) { return $repository->createQueryBuilder('p'); }, 'property' => 'nome'))
