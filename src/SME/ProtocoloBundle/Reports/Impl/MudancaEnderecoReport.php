...
class MudancaNomeReport extends RequerimentoReport
{
    ...
    private function rel($via) {
        $this->titulo = 'REQUERIMENTO DE MUDANÇA DE NOME';
        $this->AddPage();
        $this->AliasNbPages();
        ...
        $this->MultiCell(540, 16, 'Eu, servidor acima identificado, venho requerer a Vsª se digne conceder a MUDANÇA DE NOME para o nome acima mencionado.', 0, 'J');
