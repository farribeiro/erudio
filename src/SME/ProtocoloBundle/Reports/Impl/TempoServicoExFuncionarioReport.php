...
class TempoServicoExFuncionarioReport extends RequerimentoReport
{
    ...
    public function prepareDocument() {
        ...
        if(isset($this->params['anoInicio'])) {
            $this->SetFont('Arial','', 9);
            $this->Cell(320,10,'Período em que trabalhou pela primeira vez no município', '', 1, 'J');
            $this->SetFont('Arial', '', 10);
            $this->Cell(320, 20, $this->params['anoInicio'], 'LTBR', 1, 'J');
            $this->Ln(5);
        }
