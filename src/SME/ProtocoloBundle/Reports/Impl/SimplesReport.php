...
class SimplesReport extends RequerimentoReport
{
    ...
    private function rel($via) {
        $this->titulo = 'REQUERIMENTO SIMPLES';
        $this->AddPage();
        $this->AliasNbPages();
        ...
        //----------------------------------------------------------------
        $this->SetFont('Arial','', 9);
        $this->Cell(350,10,'Matrícula', '', 1, 'J');

        $this->SetFont('Arial', '', 10);
        $this->Cell(350, 20, isset($this->params['matricula']) ? $this->params['matricula'] : '', 'LTBR', 1, 'J');
        $this->Ln(5);
