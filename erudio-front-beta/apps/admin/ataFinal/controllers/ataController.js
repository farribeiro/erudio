...
(function (){
    /*
     * @ErudioDoc Ata Final Controller
     * @Module ataFinal
    ...
    class AtaController {
        constructor (service, util, $mdDialog, erudioConfig, $timeout, cursoService, unidadeService, $scope, cursoOfertadoService, turmaService) {
            ...
            this.cursoOfertadoService = cursoOfertadoService; this.turmaService = turmaService; this.curso = {id: null}; this.etapa = {id: null};
        ...
        preparaBusca(){
            ...
            this.buscaCustom = this.util.setBuscaCustom('/apps/admin/ataFinal/partials');
        }
        /*
         * @method filtrar
         * @methodReturn Array
         ...
         */
        imprimir() {
            var url = this.erudioConfig.urlServidor+'/report/ata-resultado-final?turma='+this.turma.id;
        ...
        iniciar(){
            ...
            if (permissao) {
                ...
                this.util.mudarImagemToolbar('ataFinal/assets/images/ata.png');
                this.preparaLista();
                this.preparaBusca();
