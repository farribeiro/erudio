...
(function (){
    var certificadosDirectives = angular.module('certificadosDirectives', []);
    certificadosDirectives.directive('controleCertificado', function (){
        return { restrict: 'E', templateUrl: 'app/modules/certificados/partials/controle.html' };
    });
    
    certificadosDirectives.directive('modalCertificado', function (){
        return { restrict: 'E', templateUrl: 'app/modules/certificados/partials/modal.html' };
    });
    
    certificadosDirectives.directive('erroBuscaCertificado', function (){
        return { restrict: 'E', templateUrl: 'app/modules/certificados/partials/erro.html' };
    });
    /*
