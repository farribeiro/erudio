...
(function (){
    var espelhoDirectives = angular.module('espelhoDirectives', []);
    espelhoDirectives.directive('controleEspelho', function (){
        return { restrict: 'E', templateUrl: 'app/modules/espelho/partials/controle.html' };
    });
    
    espelhoDirectives.directive('modalEspelho', function (){
        return { restrict: 'E', templateUrl: 'app/modules/espelho/partials/modal.html' };
    });
    
    espelhoDirectives.directive('erroBuscaEspelho', function (){
        return { restrict: 'E', templateUrl: 'app/modules/espelho/partials/erro.html' };
    });
    /*
