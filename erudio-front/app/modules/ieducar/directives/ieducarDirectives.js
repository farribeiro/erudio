...
(function (){
    var ieducarDirectives = angular.module('ieducarDirectives', []);
    ieducarDirectives.directive('controleIeducar', function (){
        return { restrict: 'E', templateUrl: 'app/modules/ieducar/partials/controle.html' };
    });
    
    ieducarDirectives.directive('modalIeducar', function (){
        return { restrict: 'E', templateUrl: 'app/modules/ieducar/partials/modal.html' };
    });
    
    ieducarDirectives.directive('erroBuscaIeducar', function (){
        return { restrict: 'E', templateUrl: 'app/modules/ieducar/partials/erro.html' };
    });
    /*
