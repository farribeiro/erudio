...
(function () {
    var alunosANEEModule = angular.module('alunosANEEModule', ['servidorModule', 'alunosANEEDirectives', 'erudioConfig']);
    //DEFINIÇÃO DO CONTROLADOR
    alunosANEEModule.controller('AlunosANEEController', ['$scope', 'Servidor', '$timeout', '$templateCache', 'ErudioConfig', function ($scope, Servidor, $timeout, $templateCache, ErudioConfig) {
        ...
        //ATRIBUTOS
        $scope.titulo = "Alunos ANEE"; $scope.progresso = false; $scope.cortina = false; $scope.ativo = 'nominal'; $scope.nomeUnidade = null; $scope.turmas = []; $scope.etapas = []; $scope.unidades = []; $scope.cursos = []; $scope.height = $(window).height()-205;
        $scope.unidade = {id:null}; $scope.instituicao = {id:null}; $scope.instituicoes =[]; $scope.nomeUnidadeRelatorioUnidade = null; $scope.curso = {id:null};
        //ABRE AJUDA
        ...
        $scope.selecionaInstituicao = function(instituicao) {
            //$scope.mostraProgresso(); 
            $scope.instituicao.id = instituicao;
            /*$timeout(function(){ 
        ...
        //INICIALIZANDO
        $scope.buscarUnidades(); $scope.buscarInstituicoes(); $scope.inicializar();
    }]);
})();
