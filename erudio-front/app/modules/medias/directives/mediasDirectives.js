...
(function (){
    var mediaDirectives = angular.module('mediaDirectives', []);
    mediaDirectives.directive('controleMedias', function (){
        return { restrict: 'E', templateUrl: 'app/modules/medias/partials/controle.html' };
    });
    
    mediaDirectives.directive('modalMedias', function (){
        return { restrict: 'E', templateUrl: 'app/modules/medias/partials/modal.html' };
    });
    
    mediaDirectives.directive('erroBuscaMedias', function (){
        return { restrict: 'E', templateUrl: 'app/modules/medias/partials/erro.html' };
    });
    /*
