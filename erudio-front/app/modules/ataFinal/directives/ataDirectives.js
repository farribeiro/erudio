...
(function (){
    var ataDirectives = angular.module('ataDirectives', []);
    ataDirectives.directive('controleAta', function (){
        return { restrict: 'E', templateUrl: 'app/modules/ataFinal/partials/controle.html' };
    });
    
    ataDirectives.directive('modalAta', function (){
        return { restrict: 'E', templateUrl: 'app/modules/ataFinal/partials/modal.html' };
    });
    
    ataDirectives.directive('erroBuscaAta', function (){
        return { restrict: 'E', templateUrl: 'app/modules/ataFinal/partials/erro.html' };
    });
    /*
