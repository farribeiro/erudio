...
(function (){
    var boletinsDirectives = angular.module('boletinsDirectives', []);
    boletinsDirectives.directive('controleBoletins', function (){
        return { restrict: 'E', templateUrl: 'app/modules/boletins/partials/controle.html' };
    });
    
    boletinsDirectives.directive('modalBoletins', function (){
        return { restrict: 'E', templateUrl: 'app/modules/boletins/partials/modal.html' };
    });
    
    boletinsDirectives.directive('erroBuscaBoletins', function (){
        return { restrict: 'E', templateUrl: 'app/modules/boletins/partials/erro.html' };
    });
    /*
